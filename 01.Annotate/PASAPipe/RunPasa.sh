...
perl /home/pabster212/Programs/PASApipeline/scripts/build_comprehensive_transcriptome.dbi -c alignAssembly.config -t ${TrinityDeNovo} --min_per_ID 95 --min_per_aligned 30
